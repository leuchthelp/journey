...
export type JellyfinProviderError = "ApiEntryRetrievalError" | "MissingServerIdError" | "MissingUserIdError" | "MissingUrlError" | "FailedUuidParseError" | "FailedPasswordAuthError" | "FailedBuildConfigError";
...
export type ProviderError = "TooManyCredentialsError" | "NoCredentialsError" | "NoSuchVariantError" | "FailedCreateEntryError" | "FailedRemoveEntryError" | "SaveTokenError" | "FailedDbInsertError" | "FailedDbRemoveError" | "FailedConvModelError" | "FailedParseUrlError" | ({ JellyfinProviderError: JellyfinProviderError }) & { JourneyDbError?: never } | ({ JourneyDbError: JourneyDbError }) & { JellyfinProviderError?: never };
...
const ARGS_MAP = {"content":{"get_content":[]},"image":{"get_images":[]},"mediaItem":{"get_media_items":[]},"original":{"get_original":[]},"provider":{"deregister":["key"],"get_provider":["key"],"get_providers":[],"password_auth":["url","ty","uname","psw"]}};

const RESULT_MAP = {"content":{"get_content":true},"image":{"get_images":true},"mediaItem":{"get_media_items":true},"original":{"get_original":true},"provider":{"deregister":true,"get_provider":true,"get_providers":true,"password_auth":true}};
