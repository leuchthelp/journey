...
const ARGS_MAP = {"":{"get_content":[],"get_images":[],"get_media_items":[],"get_original":[],"get_providers":[]}};

const RESULT_MAP = {"":{"get_content":false,"get_images":false,"get_media_items":false,"get_original":false,"get_providers":false}};
